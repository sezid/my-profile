...
const News = () => {
  return (
    <div className='flex flex-col items-center justify-center text-4xl mt-10'>
      ...
      <div className='flex flex-col w-[300px] md:w-1/2 bg-white mt-10 justify-start p-[30px] md:p-[60px] rounded-[10px] font-poppins gap-10 text-base h-[300px] md:h-[500px] overflow-y-scroll'>
