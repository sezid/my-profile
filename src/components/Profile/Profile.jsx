    ...
    <div className='profile'>
        <div className="profile-box">
            ...
            <div className="profile-info-sum">
                <h2>Summary</h2>
                <p>As a recent Computer Science graduate, I am deeply passionate about leveraging both datascience and AI, as well as software development, to solve real-world problems and make ameaningful impact. My strong technical skills in programming, algorithms, and software engineering, combined with my enthusiasm for innovation, fuel my drive to contribute in these fields.<br>I thrive in dynamic, fast-paced environments and enjoy collaborating with diverse teams to tackle complex challenges. My adaptability allows me to quickly learn and integrate new technologies and methodologies into my work. Whether it's building software solutions or using data-driven approaches, I am committed to developing high-quality, impactful projects that benefit society.<br>I am eager to continue growing in these areas and making meaningful contributions that improve lives and advance technology for the greater good. </p></div>
         </div>
